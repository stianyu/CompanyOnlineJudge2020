...
public class CheckDomainTest2 {
    public static void main(String[] args) {
        String str = "&";
        String str2 = "www.bigo.arg";
        String str3 = ".www.bigo.arg";
        String str4 = "www.bigo.arg.";
        String str5 = "abcdefghigklmnopqrstuvwxyzabcdefghigklmnopqrstuvwxyz.bigo.arg";
        String str6 = "ww-.bigo.arg";
        String str7 = "ww..bigo.arg";
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            if (isWhat(chars[i]) > 0) {
                ...
                if (i == 0 || i == chars.length - 1) {
                    ...
                    // 如果标签第一个字符为分隔符或连接符，则输出非法代码4
                    if (labelCount == 0 && isWhat(chars[i]) > 1) {
                        code = 4;
                        break;
                    }
                    ...
                    // 如果当前字符为字母或数字，则标签计数+1，且设置上一个字符不是连接符
                    if (isWhat(chars[i]) == 1) {
                        labelCount++;
